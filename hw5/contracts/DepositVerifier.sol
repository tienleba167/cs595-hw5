...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            qr: Honk.G1Point({ 
               x: uint256(0x22a1ef16f00497a4a7497d0ab88629bf0742b337e52cbb4e37cce0095e08cdf9),
               y: uint256(0x10114c56ffa99c3f4a2decdc723b02b8dfdcacb8f013827f1f793c3c387bcd1c)
            }),
            qo: Honk.G1Point({ 
            ...
            qc: Honk.G1Point({ 
               x: uint256(0x18b011820d44e00b03e8f290bbc1756bc5facc3a7b94f397caa2cd47265dbc76),
               y: uint256(0x0a1037bbeb42503be3c14b0c640a78f8dbc69abd8e5c39d82281913fa2da185e)
            }),
            qArith: Honk.G1Point({ 
